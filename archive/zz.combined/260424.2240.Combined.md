...
Generated: 2026-04-24 22:40:08.971186
...
DEPENDS: Lorentz rigidity (cone-preserving symmetry), --, Harmonic compression principle (U as admissible spectrum), Spectral admissibility / trace-admissibility framework, N1
---
...
DEPENDS: F5 — Structural Role of Physical Constants, --, N0, N1
---
...
DEPENDS: :, --, dimension (4D used), Additional fields modify coefficient, representation (Dirac spinor), choice of D
---
...
DEPENDS: k, wavevector., wave packets spread over time, ⚠ requires further admissibility constraints, --, ✔ may be cone-compatible (locally or band-limited), Status:
---
...
DEPENDS: N5, --, N2, N1, N1b — Admissibility ⇒ Hyperbolicity
---
...
DEPENDS: N8, 04-propagation_rigidity, QM-EXT-002, dirac_factorisation
---
...
TITLE: Ddf p3.5
DEPENDS: the current observable state., L_\psi, -----, the current observable state ( \psi )., No physical laws or constants are derived in this paper., [, ], representing the realised action of (L) under state-dependent constraints., We denote this as:
---
...
DEPENDS: So:, 4. **Emergent variation**, 2. **Self-regulation**, -----, the state is determined by the operator,, 3. **Single origin**, the solution must satisfy both simultaneously., the state,, > the source does not change — the **environment changes how it appears**, system moves toward balance, all behaviour comes from one source, observed behaviour = result of their combination, its own state, the current state of (U), differences arise from response, not multiple sources
---
