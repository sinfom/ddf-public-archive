...
Generated: 2026-05-24 07:04:07.765861
...
DEPENDS: N1, --, Lorentz rigidity (cone-preserving symmetry), Harmonic compression principle (U as admissible spectrum), Spectral admissibility / trace-admissibility framework
---
...
DEPENDS: Additional fields modify coefficient, choice of D, dimension (4D used), :, --, representation (Dirac spinor)
---
...
DEPENDS: F8 — Projection Generator, F2 — Projection Constraints, F1 — Harmonic Projection, N1, --, N1p — Phase / Dispersion Interpretation, N0, N1b — Admissibility and Hyperbolicity, Microlocal Formulation, F5 — Structural Role of Physical Constants
---
...
DEPENDS: may be cone-compatible locally or approximately;, \(k\);, extra internal degrees of freedom;, may be admissible as an effective or emergent correction;, effective medium behaviour;, high-frequency behaviour can violate global cone structure unless band-limited;, Reason:, --, broken Lorentz covariance;, preferred frame or scale;, band-limited validity., higher-order derivatives;, Status:, wave packets spread;, Nonlinear dispersion generally requires at least one of:, is not globally admissible as a fundamental irreducible scalar dispersion law.
---
...
DEPENDS: QM-EXT-002, N8, 04-propagation_rigidity, dirac_factorisation
---
...
TITLE: Ddf p3.5
DEPENDS: We denote this as:, ], the current observable state., representing the realised action of (L) under state-dependent constraints., -----, No physical laws or constants are derived in this paper., [, the current observable state ( \psi )., L_\psi
---
...
DEPENDS: > the source does not change — the **environment changes how it appears**, the state,, observed behaviour = result of their combination, the state is determined by the operator,, 3. **Single origin**, 4. **Emergent variation**, 2. **Self-regulation**, the solution must satisfy both simultaneously., its own state, differences arise from response, not multiple sources, all behaviour comes from one source, -----, the current state of (U), system moves toward balance, So:
---
...
# N2b-dispersion-admissibility-corrected.md


---
FILE: N2b-dispersion-admissibility-corrected.md
ID: N2b
