...
Generated: 2026-05-06 23:20:55.137619
...
DEPENDS: Lorentz rigidity (cone-preserving symmetry), N1, --, Spectral admissibility / trace-admissibility framework, Harmonic compression principle (U as admissible spectrum)
---
...
DEPENDS: F8 — Projection Generator, F2 — Projection Constraints, N0, N1p — Phase / Dispersion Interpretation, N1, F5 — Structural Role of Physical Constants, --, F1 — Harmonic Projection, N1b — Admissibility and Hyperbolicity, Microlocal Formulation
---
...
DEPENDS: --, N1, F5 — Structural Role of Physical Constants, N0
---
...
DEPENDS: Nonlinear dispersion generally requires at least one of:, wave packets spread;, \(k\);, broken Lorentz covariance;, band-limited validity., may be admissible as an effective or emergent correction;, --, effective medium behaviour;, preferred frame or scale;, is not globally admissible as a fundamental irreducible scalar dispersion law., Reason:, higher-order derivatives;, Status:, high-frequency behaviour can violate global cone structure unless band-limited;, may be cone-compatible locally or approximately;, extra internal degrees of freedom;
---
...
DEPENDS: N5, N1, N1b — Admissibility ⇒ Hyperbolicity, --, N2
---
...
DEPENDS: 04-propagation_rigidity, dirac_factorisation, N8, QM-EXT-002
---
...
TITLE: Ddf p3.5
DEPENDS: representing the realised action of (L) under state-dependent constraints., L_\psi, No physical laws or constants are derived in this paper., -----, We denote this as:, the current observable state., ], [, the current observable state ( \psi ).
---
...
TITLE: Ddf p4
DEPENDS: ( \psi ), -----, feedback influences admissible states and solutions, However:, the operator (L^\dagger L) remains well-defined
---
...
DEPENDS: -----, 2. **Self-regulation**, the current state of (U), system moves toward balance, 4. **Emergent variation**, the state is determined by the operator,, the state,, the solution must satisfy both simultaneously., all behaviour comes from one source, differences arise from response, not multiple sources, 3. **Single origin**, its own state, > the source does not change — the **environment changes how it appears**, So:, observed behaviour = result of their combination
---
