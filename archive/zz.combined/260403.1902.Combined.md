...
Generated: 2026-04-03 19:02:01.257276
...
DEPENDS: --, ✔ may be cone-compatible (locally or band-limited), Status:, wave packets spread over time, ⚠ requires further admissibility constraints, k, wavevector.
---
...
DEPENDS: --, N1b — Admissibility ⇒ Hyperbolicity, N5, N2, N1
---
...
DEPENDS: DDF-QM-EXT-002, 01_foundations F1–F4, 02_operator_notes (Dirac factorisation, spin)
---
...
ID: QM-EXT-004
DEPENDS: DDF-QM-EXT-002, N8, dirac_factorisation, 04-propagation_rigidity
---
...
DEPENDS: No physical laws or constants are derived in this paper., the current observable state., L_\psi, the current observable state ( \psi )., ], [, representing the realised action of (L) under state-dependent constraints., -----, We denote this as:
---
...
DEPENDS: However:, feedback influences admissible states and solutions, ( \psi ), the operator (L^\dagger L) remains well-defined, -----
---
...
DEPENDS: > the source does not change — the **environment changes how it appears**, system moves toward balance, So:, 2. **Self-regulation**, the current state of (U), its own state, 4. **Emergent variation**, 3. **Single origin**, differences arise from response, not multiple sources, -----, the solution must satisfy both simultaneously., all behaviour comes from one source, the state,, the state is determined by the operator,, observed behaviour = result of their combination
---
