...
Generated: 2026-05-06 23:19:47.333779
...
DEPENDS: Spectral admissibility / trace-admissibility framework, Lorentz rigidity (cone-preserving symmetry), --, Harmonic compression principle (U as admissible spectrum), N1
---
...
DEPENDS: Additional fields modify coefficient, dimension (4D used), :, choice of D, representation (Dirac spinor), --
---
...
DEPENDS: F5 — Structural Role of Physical Constants, N1b — Admissibility and Hyperbolicity, Microlocal Formulation, F1 — Harmonic Projection, --, F2 — Projection Constraints, F8 — Projection Generator, N1, N0, N1p — Phase / Dispersion Interpretation
---
...
DEPENDS: F5 — Structural Role of Physical Constants, N1, N0, --
---
...
DEPENDS: wave packets spread;, high-frequency behaviour can violate global cone structure unless band-limited;, Reason:, is not globally admissible as a fundamental irreducible scalar dispersion law., may be admissible as an effective or emergent correction;, preferred frame or scale;, extra internal degrees of freedom;, Nonlinear dispersion generally requires at least one of:, broken Lorentz covariance;, higher-order derivatives;, \(k\);, Status:, effective medium behaviour;, --, may be cone-compatible locally or approximately;, band-limited validity.
---
...
DEPENDS: N1b — Admissibility ⇒ Hyperbolicity, --, N5, N1, N2
---
...
DEPENDS: QM-EXT-002, 01_foundations F1–F4, 02_operator_notes (Dirac factorisation, spin)
---
...
DEPENDS: N8, QM-EXT-002, dirac_factorisation, 04-propagation_rigidity
---
...
TITLE: Ddf p3.5
DEPENDS: the current observable state., No physical laws or constants are derived in this paper., representing the realised action of (L) under state-dependent constraints., L_\psi, ], [, We denote this as:, -----, the current observable state ( \psi ).
---
...
TITLE: Ddf p4
DEPENDS: feedback influences admissible states and solutions, -----, ( \psi ), However:, the operator (L^\dagger L) remains well-defined
---
...
DEPENDS: its own state, the state is determined by the operator,, > the source does not change — the **environment changes how it appears**, 3. **Single origin**, the solution must satisfy both simultaneously., all behaviour comes from one source, differences arise from response, not multiple sources, So:, observed behaviour = result of their combination, the state,, 2. **Self-regulation**, 4. **Emergent variation**, the current state of (U), -----, system moves toward balance
---
