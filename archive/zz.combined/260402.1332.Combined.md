...
Generated: 2026-04-02 13:32:40.339235
...
DEPENDS: :, representation (Dirac spinor), choice of D, --, dimension (4D used), Additional fields modify coefficient
---
...
DEPENDS: k, ⚠ requires further admissibility constraints, Status:, ✔ may be cone-compatible (locally or band-limited), wavevector., --, wave packets spread over time
---
...
DEPENDS: N2, N1, N5, --, N1b — Admissibility ⇒ Hyperbolicity
---
...
DEPENDS: DDF-QM-EXT-002A, DDF-QM-EXT-002
---
...
ID: DDF-QM-EXT-003
DEPENDS: DDF-QM-EXT-002 (Multi-Projection Entanglement), DDF-QM-EXT-001 (Projection Degeneracy)
---
...
ID: QM-EXT-004
DEPENDS: 04-propagation_rigidity, DDF-QM-EXT-002, dirac_factorisation, N8
---
...
DEPENDS: system moves toward balance, the state,, 2. **Self-regulation**, the current state of (U), observed behaviour = result of their combination, its own state, -----, the solution must satisfy both simultaneously., 3. **Single origin**, differences arise from response, not multiple sources, > the source does not change — the **environment changes how it appears**, So:, all behaviour comes from one source, the state is determined by the operator,, 4. **Emergent variation**
---
