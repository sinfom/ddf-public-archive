...
Generated: 2026-04-02 14:02:05.164912
...
DEPENDS: ✔ may be cone-compatible (locally or band-limited), wavevector., wave packets spread over time, Status:, k, --, ⚠ requires further admissibility constraints
---
...
DEPENDS: N2, N5, N1, --, N1b — Admissibility ⇒ Hyperbolicity
---
...
DEPENDS: 01_foundations F1–F4, DDF-QM-EXT-002, 02_operator_notes (Dirac factorisation, spin)
---
...
DEPENDS: 2. **Self-regulation**, its own state, 4. **Emergent variation**, all behaviour comes from one source, > the source does not change — the **environment changes how it appears**, system moves toward balance, the state is determined by the operator,, observed behaviour = result of their combination, -----, 3. **Single origin**, the solution must satisfy both simultaneously., So:, the state,, differences arise from response, not multiple sources, the current state of (U)
---
